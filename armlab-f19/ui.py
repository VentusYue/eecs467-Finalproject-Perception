...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # Add button for exploration code
        self.explore_btn = QtGui.QPushButton(self.centralwidget)
        self.explore_btn.setGeometry(QtCore.QRect(900, 600, 311, 71))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.explore_btn.setFont(font)
        self.explore_btn.setObjectName(_fromUtf8("btn_explore"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.radioApril.setText(_translate("MainWindow", "AprilTags", None))
        self.radioUsr1.setText(_translate("MainWindow", "block", None))
